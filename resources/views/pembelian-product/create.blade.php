        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Tambah Pembelian Product</h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                @endif
                                <form id="quickForm" action="{{ route('pembelian-product.create.post') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror">
                                                ...
                                                @foreach ($products as $key => $product)
                                                    <option @selected(old('product') == $product->id) value="{{ $product->id }}">
                                                        {{ $product->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('product')
