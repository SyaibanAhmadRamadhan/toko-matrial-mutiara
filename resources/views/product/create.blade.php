                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                @endif
                                <form id="quickForm" action="{{ route('product.create.post') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror">
                                                ...
                                                @foreach ($suppliers as $key => $supplier)
                                                    <option @selected(old('supplier') == $supplier->id) value="{{ $supplier->id }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror">
                                                ...
                                                @foreach ($categoryProducts as $key => $categoryProduct)
                                                    <option @selected(old('category_product') == $categoryProduct->id) value="{{ $categoryProduct->id }}">
