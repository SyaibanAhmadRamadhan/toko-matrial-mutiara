                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                @endif
                                <form id="quickForm"
                                    action="{{ route('pengeluaran.update.post', ['id' => $pengeluaran->id]) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tanggal_keluar"
                                                ...
                                                is-invalid
                                            @enderror"
                                                value="{{ old('tanggal_keluar', $pengeluaran->tanggal_keluar) }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @enderror"
                                                ...
                                                value="{{ old('uang_keluar', $pengeluaran->uang_keluar) }}">
                                            @error('uang_keluar')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="keterangan"
                                                ...
                                                is-invalid
                                            @enderror"
                                                id="keterangan" placeholder="Masukan keterangan">{{ old('keterangan', $pengeluaran->keterangan) }}</textarea>
                                            @error('keterangan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
